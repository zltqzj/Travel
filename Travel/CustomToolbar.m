...
-(void)getButton:(CGRect)rect type:(UIButtonType)type title:(NSString*)title titleColor:(UIColor*)titleColor bgColor:(UIColor*)bgColor image:(UIImage*)image{
    ...
    [self.ToolbarItems addObject:btn];
    [self addSubview:btn];
}

//
//-(void)addBtn:(CGRect)frame{
//    
//    
//    UIButton *NewToolbarBtn = [UIButton buttonWithType:UIButtonTypeCustom];
//    NewToolbarBtn.frame =  frame;
//    NewToolbarBtn.backgroundColor = [UIColor orangeColor];
//    [NewToolbarBtn setTitle:@"电话咨询" forState:UIControlStateNormal];
//    //[NewToolbarBtn defaultStyle];
//    [self.ToolbarItems addObject:NewToolbarBtn];
//    [self addSubview:NewToolbarBtn];
//    
//}
