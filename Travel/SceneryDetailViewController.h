...
@interface SceneryDetailViewController : UIViewController<LXActionSheetDelegate,UITableViewDataSource,UITableViewDelegate>
...
@property(strong,nonatomic) UILabel*  sceneryDescLabel;// 景区介绍标签
@end
